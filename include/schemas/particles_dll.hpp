...
namespace particles {
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_fMinimumDistance                              , 0x368) // CPerParticleFloatInput
        SCHEMA_FIELD(float                           , m_fFalloffPower                                 , 0x4D8) // float32
        SCHEMA_FIELD(::animationsystem::CParticleTransformInput, m_TransformInput                                , 0x4E0) // CParticleTransformInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_fForceAmountMin                               , 0x548) // CPerParticleFloatInput
        SCHEMA_FIELD(bool                            , m_bApplyMinForce                                , 0x6B8) // bool
    };
    ...
    public:
        ...
        SCHEMA_FIELD(bool                            , m_bPrevious                                     , 0x350) // bool
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::CUtlString                    , m_strLightStyle                                 , 0x2C68) // CUtlString
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flLightStyleTime                              , 0x2C70) // CPerParticleFloatInput
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CPerParticleVecInput, m_vPrevPosition                                 , 0xFB0) // CPerParticleVecInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flSpeed                                       , 0x1668) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flRadius                                      , 0x17D8) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flDensity                                     , 0x1948) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flTemperature                                 , 0x1AB8) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flMagnitude                                   , 0x1C28) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flKillRadius                                  , 0x1D98) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flKillDensityScale                            , 0x1F08) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flFalloff                                     , 0x2078) // CPerParticleFloatInput
    };
    ...
    public:
        ...
        SCHEMA_FIELD(float                           , m_flRotOffset                                   , 0x890) // float32
        SCHEMA_FIELD(float                           , m_flSpinStrength                                , 0x894) // float32
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nFieldOutput                                  , 0x898) // ParticleAttributeIndex_t
    };
    ...
    class C_INIT_SkyVisCull {
    public:
        SCHEMA_FIELD(::animationsystem::CParticleCollectionVecInput, m_vecTestDir                                    , 0x1E0) // CParticleCollectionVecInput
        SCHEMA_FIELD(ParticleTraceSet_t              , m_nTraceSet                                     , 0x898) // ParticleTraceSet_t
        SCHEMA_FIELD(bool                            , m_bCullOnSky                                    , 0x89C) // bool
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::CUtlString                    , m_strLightStyle                                 , 0x8F0) // CUtlString
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flLightStyleTime                              , 0x8F8) // CPerParticleFloatInput
        SCHEMA_FIELD(ParticleLightUnitChoiceList_t   , m_nBrightnessUnit                               , 0xA68) // ParticleLightUnitChoiceList_t
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flBrightnessLumens                            , 0xA70) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flBrightnessCandelas                          , 0xBE0) // CPerParticleFloatInput
        SCHEMA_FIELD(bool                            , m_bCastShadows                                  , 0xD50) // bool
        SCHEMA_FIELD(bool                            , m_bDynamicBounce                                , 0xD51) // bool
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flBounceScale                                 , 0xD58) // CParticleCollectionFloatInput
        SCHEMA_FIELD(bool                            , m_bFog                                          , 0xEC8) // bool
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flFogScale                                    , 0xED0) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flLuminaireRadius                             , 0x1040) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flSkirt                                       , 0x11B0) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flRange                                       , 0x1320) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flInnerConeAngle                              , 0x1490) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flOuterConeAngle                              , 0x1600) // CPerParticleFloatInput
        SCHEMA_FIELD(CStrongHandle<InfoForResourceTypeCTextureBase>, m_hLightCookie                                  , 0x1770) // CStrongHandle<InfoForResourceTypeCTextureBase>
        SCHEMA_FIELD(bool                            , m_bSphericalCookie                              , 0x1778) // bool
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flSubPixelAAScale                             , 0x30E0) // CParticleCollectionRendererFloatInput
        SCHEMA_FIELD(bool                            , m_bClampV                                       , 0x3250) // bool
    };
    ...
    public:
        ...
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nNoCollisionAttribute                         , 0x534) // ParticleAttributeIndex_t
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nZeroGravityAttribute                         , 0x538) // ParticleAttributeIndex_t
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flScollOffset                                 , 0x368) // CParticleCollectionFloatInput
        SCHEMA_FIELD(CUtlVector<ParticleMultiSegmentSpecialCharacter_t>, m_SpecialCharList                               , 0x4D8) // CUtlVector<ParticleMultiSegmentSpecialCharacter_t>
        SCHEMA_FIELD(::animationsystem::CParticleCollectionVecInput, m_vecColorUnlit                                 , 0x4F0) // CParticleCollectionVecInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionVecInput, m_vecColorLit                                   , 0xBA8) // CParticleCollectionVecInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flRadius                                      , 0x1260) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flSpacing                                     , 0x13D0) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flMinCount                                    , 0x1540) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flMaxCount                                    , 0x16B0) // CParticleCollectionFloatInput
        SCHEMA_FIELD(bool                            , m_bPrependEmpty                                 , 0x1820) // bool
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flDigitsAfterDecimal                          , 0x1828) // CParticleCollectionFloatInput
    };
    ...
    public:
        ...
        SCHEMA_FIELD(std::int32_t                    , m_nRadiusCP                                     , 0x1F8) // int32
        SCHEMA_FIELD(std::int32_t                    , m_nRadiusCPField                                , 0x1FC) // int32
    };
    ...
    public:
        ...
        SCHEMA_FIELD(bool                            , m_bOnlyRenderInEffectsBloomPass                 , 0x1495) // bool
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flRadius                                      , 0x508) // CParticleCollectionFloatInput
        SCHEMA_FIELD(bool                            , m_bCheckExposedToSky                            , 0x678) // bool
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nAmountAttribute                              , 0x67C) // ParticleAttributeIndex_t
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::CUtlString                    , m_strLightStyle                                 , 0x8F0) // CUtlString
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flLightStyleTime                              , 0x8F8) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flIntensity                                   , 0xA68) // CPerParticleFloatInput
        SCHEMA_FIELD(bool                            , m_bCastShadows                                  , 0xBD8) // bool
        SCHEMA_FIELD(bool                            , m_bDynamicBounce                                , 0xBD9) // bool
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flBounceScale                                 , 0xBE0) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flTheta                                       , 0xD50) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flPhi                                         , 0xEC0) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flRadiusMultiplier                            , 0x1030) // CParticleCollectionFloatInput
        SCHEMA_FIELD(StandardLightingAttenuationStyle_t, m_nAttenuationStyle                             , 0x11A0) // StandardLightingAttenuationStyle_t
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flFalloffLinearity                            , 0x11A8) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flFiftyPercentFalloff                         , 0x1318) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flZeroPercentFalloff                          , 0x1488) // CParticleCollectionFloatInput
        SCHEMA_FIELD(bool                            , m_bRenderDiffuse                                , 0x15F8) // bool
        SCHEMA_FIELD(bool                            , m_bRenderSpecular                               , 0x15F9) // bool
        SCHEMA_FIELD(::CUtlString                    , m_lightCookie                                   , 0x1600) // CUtlString
        SCHEMA_FIELD(std::int32_t                    , m_nPriority                                     , 0x1608) // int32
        SCHEMA_FIELD(ParticleLightFogLightingMode_t  , m_nFogLightingMode                              , 0x160C) // ParticleLightFogLightingMode_t
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flFogContribution                             , 0x1610) // CParticleCollectionRendererFloatInput
        SCHEMA_FIELD(ParticleLightBehaviorChoiceList_t, m_nCapsuleLightBehavior                         , 0x1780) // ParticleLightBehaviorChoiceList_t
        SCHEMA_FIELD(float                           , m_flCapsuleLength                               , 0x1784) // float32
        SCHEMA_FIELD(bool                            , m_bReverseOrder                                 , 0x1788) // bool
        SCHEMA_FIELD(bool                            , m_bClosedLoop                                   , 0x1789) // bool
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nPrevPntSource                                , 0x178C) // ParticleAttributeIndex_t
        SCHEMA_FIELD(float                           , m_flMaxLength                                   , 0x1790) // float32
        SCHEMA_FIELD(float                           , m_flMinLength                                   , 0x1794) // float32
        SCHEMA_FIELD(bool                            , m_bIgnoreDT                                     , 0x1798) // bool
        SCHEMA_FIELD(float                           , m_flConstrainRadiusToLengthRatio                , 0x179C) // float32
        SCHEMA_FIELD(float                           , m_flLengthScale                                 , 0x17A0) // float32
        SCHEMA_FIELD(float                           , m_flLengthFadeInTime                            , 0x17A4) // float32
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flRecursionSplitScale                         , 0xC00) // CParticleCollectionFloatInput
        SCHEMA_FIELD(bool                            , m_bScaleBranchDistance                          , 0xD70) // bool
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flBranchDistanceScale                         , 0xD78) // CParticleCollectionFloatInput
        SCHEMA_FIELD(bool                            , m_bScaleBranchOffset                            , 0xEE8) // bool
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flBranchOffsetScale                           , 0xEF0) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flBranchTwist                                 , 0x1060) // CParticleCollectionFloatInput
        SCHEMA_FIELD(ParticleLightnintBranchBehavior_t, m_nBranchBehavior                               , 0x11D0) // ParticleLightnintBranchBehavior_t
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flRadiusStart                                 , 0x11D8) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flRadiusEnd                                   , 0x1348) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flDedicatedPool                               , 0x14B8) // CParticleCollectionFloatInput
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::CUtlString                    , m_strLightStyle                                 , 0x8F0) // CUtlString
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flLightStyleTime                              , 0x8F8) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flBrightnessLumensPerMeter                    , 0xA68) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flNumberOfLightsToCreate                      , 0xBD8) // CParticleCollectionFloatInput
        SCHEMA_FIELD(bool                            , m_bCastShadows                                  , 0xD48) // bool
        SCHEMA_FIELD(bool                            , m_bDynamicBounce                                , 0xD49) // bool
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flBounceScale                                 , 0xD50) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flSkirt                                       , 0xEC0) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flRange                                       , 0x1030) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flThickness                                   , 0x11A0) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flInnerConeAngle                              , 0x1310) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionFloatInput, m_flOuterConeAngle                              , 0x1480) // CParticleCollectionFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionVecInput, m_vecConeRotationOffset                         , 0x15F0) // CParticleCollectionVecInput
        SCHEMA_FIELD(ParticleLightFogLightingMode_t  , m_nFogLightingMode                              , 0x1CA8) // ParticleLightFogLightingMode_t
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flFogContribution                             , 0x1CB0) // CParticleCollectionRendererFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flRenderFilter                                , 0x1E20) // CPerParticleFloatInput
        SCHEMA_FIELD(bool                            , m_bDebugOrientation                             , 0x1F90) // bool
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flSubPixelAAScale                             , 0x2E10) // CParticleCollectionRendererFloatInput
        SCHEMA_FIELD(float                           , m_flRadiusTaper                                 , 0x2F80) // float32
        SCHEMA_FIELD(std::int32_t                    , m_nMinTesselation                               , 0x2F84) // int32
        SCHEMA_FIELD(std::int32_t                    , m_nMaxTesselation                               , 0x2F88) // int32
        SCHEMA_FIELD(float                           , m_flTessScale                                   , 0x2F8C) // float32
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flTextureVWorldSize                           , 0x2F90) // CParticleCollectionRendererFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flTextureVScrollRate                          , 0x3100) // CParticleCollectionRendererFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flTextureVOffset                              , 0x3270) // CParticleCollectionRendererFloatInput
        SCHEMA_FIELD(std::int32_t                    , m_nTextureVParamsCP                             , 0x33E0) // int32
        SCHEMA_FIELD(bool                            , m_bClampV                                       , 0x33E4) // bool
        SCHEMA_FIELD(std::int32_t                    , m_nScaleCP1                                     , 0x33E8) // int32
        SCHEMA_FIELD(std::int32_t                    , m_nScaleCP2                                     , 0x33EC) // int32
        SCHEMA_FIELD(float                           , m_flScaleVSizeByControlPointDistance            , 0x33F0) // float32
        SCHEMA_FIELD(float                           , m_flScaleVScrollByControlPointDistance          , 0x33F4) // float32
        SCHEMA_FIELD(float                           , m_flScaleVOffsetByControlPointDistance          , 0x33F8) // float32
        SCHEMA_FIELD(bool                            , m_bUseScalarForTextureCoordinate                , 0x33FD) // bool
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nScalarFieldForTextureCoordinate              , 0x3400) // ParticleAttributeIndex_t
        SCHEMA_FIELD(float                           , m_flScalarAttributeTextureCoordScale            , 0x3404) // float32
        SCHEMA_FIELD(bool                            , m_bReverseOrder                                 , 0x3408) // bool
        SCHEMA_FIELD(bool                            , m_bClosedLoop                                   , 0x3409) // bool
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nSplitField                                   , 0x340C) // ParticleAttributeIndex_t
        SCHEMA_FIELD(bool                            , m_bSortBySegmentID                              , 0x3410) // bool
        SCHEMA_FIELD(ParticleOrientationChoiceList_t , m_nOrientationType                              , 0x3414) // ParticleOrientationChoiceList_t
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nVectorFieldForOrientation                    , 0x3418) // ParticleAttributeIndex_t
        SCHEMA_FIELD(bool                            , m_bDrawAsOpaque                                 , 0x341C) // bool
        SCHEMA_FIELD(bool                            , m_bGenerateNormals                              , 0x341D) // bool
    };
    ...
    class C_OP_RenderTrails {
    public:
        SCHEMA_FIELD(bool                            , m_bEnableFadingAndClamping                      , 0x3258) // bool
        SCHEMA_FIELD(float                           , m_flStartFadeDot                                , 0x325C) // float32
        SCHEMA_FIELD(float                           , m_flEndFadeDot                                  , 0x3260) // float32
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nPrevPntSource                                , 0x3264) // ParticleAttributeIndex_t
        SCHEMA_FIELD(float                           , m_flMaxLength                                   , 0x3268) // float32
        SCHEMA_FIELD(float                           , m_flMinLength                                   , 0x326C) // float32
        SCHEMA_FIELD(bool                            , m_bIgnoreDT                                     , 0x3270) // bool
        SCHEMA_FIELD(float                           , m_flConstrainRadiusToLengthRatio                , 0x3274) // float32
        SCHEMA_FIELD(float                           , m_flLengthScale                                 , 0x3278) // float32
        SCHEMA_FIELD(float                           , m_flLengthFadeInTime                            , 0x327C) // float32
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flRadiusHeadTaper                             , 0x3280) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionVecInput, m_vecHeadColorScale                             , 0x33F0) // CParticleCollectionVecInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flHeadAlphaScale                              , 0x3AA8) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flRadiusTaper                                 , 0x3C18) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CParticleCollectionVecInput, m_vecTailColorScale                             , 0x3D88) // CParticleCollectionVecInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flTailAlphaScale                              , 0x4440) // CPerParticleFloatInput
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nHorizCropField                               , 0x45B0) // ParticleAttributeIndex_t
        SCHEMA_FIELD(ParticleAttributeIndex_t        , m_nVertCropField                                , 0x45B4) // ParticleAttributeIndex_t
        SCHEMA_FIELD(float                           , m_flForwardShift                                , 0x45B8) // float32
        SCHEMA_FIELD(bool                            , m_bFlipUVBasedOnPitchYaw                        , 0x45BC) // bool
    };
    ...
    class C_OP_MaxVelocity {
    public:
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flMaxVelocity                                 , 0x1D8) // CPerParticleFloatInput
        SCHEMA_FIELD(::animationsystem::CPerParticleFloatInput, m_flMinVelocity                                 , 0x348) // CPerParticleFloatInput
    };
    ...
    public:
        ...
        SCHEMA_FIELD(::animationsystem::CParticleCollectionRendererFloatInput, m_flSubPixelAAScale                             , 0x3250) // CParticleCollectionRendererFloatInput
