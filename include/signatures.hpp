...
namespace sig {
    ...
    namespace client {
        ...
        inline constexpr std::string_view GameRulesAlt_addr = "48 8D 05 ? ? ? ? 48 89 06 48 8D 4E 44";
        ...
        inline constexpr std::string_view GameTraceManager_ptr = "48 8B 0D ? ? ? ? 48 8B D0 C7 44 24 ? 04 00 00 00 48 C7 44 24 ? 01 30 1C 00";
        ...
        inline constexpr std::string_view PlantedC4Alt_ptr = "48 8B 15 ? ? ? ? 41 FF C0 48 8D 4C 24";
        ...
        inline constexpr std::string_view SetLabelTextFunctionPointer = "40 53 56 41 56 41 57 48 83 EC 48 80 3D B2 A4 A7";
        ...
        inline constexpr std::string_view SliderSetValueFunction = "48 89 5C 24 08 48 89 74 24 10 57 48 81 EC A0 00 00 00 48 8B F2 48 8B F9";
        ...
        inline constexpr std::string_view ViewMatrix_addr = "48 8D 0D ? ? ? ? 48 C1 E0 06";
        ...
        inline constexpr std::string_view level_shutdown = "48 83 EC 28 48 8B 0D ? ? ? ? 48 8D 15 B6 A0";
        inline constexpr std::string_view local_controller = "48 8B 05 ? ? ? ? 41 89 BE";
        inline constexpr std::string_view mark_interp_latch_flags_dirty = "40 53 56 57 48 83 EC 40 80 3D F5 D4 11 02 00 8B";
    ...
    namespace engine2 {
        ...
        inline constexpr std::string_view PVSManager_ptr = "48 8D 0D ? ? ? ? 33 D2 FF 50";
